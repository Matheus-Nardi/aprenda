...
import JoinClassroomForm from "@/components/project/forms/JoinClassrrom";
...
export default function DashboardStudentPage() {
  ...
  function handleClassroomClick(id: number): void {
    route.push(`/student/dashboard/classroom/${id}`);
  }
    ...
    <div className="min-h-screen bg-background">
      <div className="container max-w-6xl mx-auto px-4 py-8 space-y-8">
        <div className="space-y-6">
          ...
          <GenericFormDialog
            title="Entrar em uma nova turma"
            description="Informe o código de convite fornecido pelo professor para entrar em uma turma existente."
            open={isDialogOpen}
              ...
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-md">
                  {searchTerm
                    ...
                    : "Entre na sua primeira turma para começar a aprender!"}
                </p>
                {!searchTerm && (
                  <Button onClick={() => setIsDialogOpen(true)}>
                    <Plus className="h-4 w-4 mr-2" />
                    Entrar na sua primeira turma
                  </Button>
                )}
              </CardContent>
            </Card>
