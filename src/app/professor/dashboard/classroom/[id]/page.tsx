        ...
        <div className="flex items-center justify-center min-h-screen">
          <Card className="max-w-md mx-4">
            <CardContent className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">{error || "Turma não encontrada"}</h3>
      ...
      <div className="container max-w-screen-2xl px-4 py-8">
        <Tabs defaultValue="posts" className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <TabsList className="grid w-full sm:w-auto grid-cols-3 bg-white border border-border/40">
              ...
              <TabsTrigger value="homeworks" className="flex items-center gap-2">
                ...
                <Badge variant="secondary" className="ml-1 bg-secondary/10 text-secondary-foreground">
                  {homeworks.length}
                </Badge>
              </TabsTrigger>
              <TabsTrigger value="students" className="flex items-center gap-2">
                ...
                <Badge variant="secondary" className="ml-1 bg-accent/10 text-accent-foreground">
                  {studentCount}
                </Badge>
              </TabsTrigger>
            </TabsList>
          ...
          <TabsContent value="posts" className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-foreground">Publicações da Turma</h2>
              ...
              {posts.length === 0 ? (
                <Card className="border-border/40 bg-white">
                  <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-foreground mb-2">Nenhuma publicação ainda</h3>
                    <p className="text-muted-foreground mb-6 max-w-md">
                      Seja o primeiro a compartilhar algo com a turma. Publique avisos, materiais ou inicie discussões.
                    </p>
                    <Button>
                      <Plus className="h-4 w-4 mr-2" />
          ...
          <TabsContent value="homeworks" className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-foreground">Atividades da Turma</h2>
                <Badge variant="outline" className="bg-white border-border/40">
                  {homeworks.length} {homeworks.length === 1 ? "atividade" : "atividades"}
                </Badge>
              </div>
              ...
              {homeworks.length === 0 ? (
                <Card className="border-border/40 bg-white">
                  <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-foreground mb-2">Nenhuma atividade criada</h3>
                    <p className="text-muted-foreground mb-6 max-w-md">
                      Crie atividades e trabalhos para engajar os alunos e acompanhar o progresso da turma.
                    </p>
                    <Button>
                      <Plus className="h-4 w-4 mr-2" />
          ...
          <TabsContent value="students" className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-foreground">Alunos da Turma</h2>
                <Badge variant="outline" className="bg-white border-border/40">
